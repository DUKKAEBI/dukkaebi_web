...
import tablerUserIcon from '../../assets/image/tabler_user.svg'
import duckkaebiLogo from '../../assets/image/duckkaebi_logo.svg'
import dubiImage from '../../assets/image/dubi.png'
import instagramIcon from '../../assets/image/mdi_instagram.svg'
import ducamiLogo from '../../assets/image/ducami_logo.svg'
import fireIcon from '../../assets/image/solar_fire-bold-duotone.svg'
	...
	const generateHeatmapData = () => {
		...
		for (let week = 0; week < 17; week++) {
			for (let day = 0; day < 7; day++) {
				const intensity = week === 10 && day >= 0 && day <= 3 ? ['20', '60', '100', '20'][day] : '0'
				data.push(intensity)
			}
		}
		return data
		...
		<S.PageWrapper>
			...
			<S.Header>
				<S.HeaderContent>
					<S.HeaderLeft>
						<S.Logo as={Link} to="/">
							<img src={duckkaebiLogo} alt="Duckkaebi Logo" style={{ width: '100%', height: '100%' }} />
						</S.Logo>
						<S.Nav>
					...
					<S.UserIcon>
						<img src={tablerUserIcon} alt="user" style={{ width: '100%', height: '100%' }} />
					</S.UserIcon>
				</S.HeaderContent>
			</S.Header>
				...
				<S.HeroSection>
					<S.HeroCard>
						<S.HeroText>
							...
							<S.HeroSubtitle>
								AI가 문제 풀이를 분석해 당신의 약점을 찾아드리고, 맞춤 학습 경로를 제안합니다.
								<br />
					...
					<S.StatsCard>
						<S.StreakInfo>
							<S.StreakContent>
								<S.StreakIcon>
									<img src={fireIcon} alt="Fire" style={{ width: '100%', height: '100%' }} />
								</S.StreakIcon>
								<S.StreakText>
				...
				<S.LearningSection>
					<S.SectionHeader>
						...
						<S.SectionTitle>
							알고리즘 완전 정복 코스
							<S.ArrowIcon>
								<img src={arrowIcon} alt="Arrow" style={{ width: '100%', height: '100%' }} />
							</S.ArrowIcon>
						</S.SectionTitle>
					</S.SectionHeader>
